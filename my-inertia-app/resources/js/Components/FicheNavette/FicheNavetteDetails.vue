...
<template>
    <div class="mb-5 bg-white p-4 rounded-lg shadow-md border border-gray-100">
        <h4 class="text-xl font-bold text-gray-800 mb-3 flex items-center">
            <svg class="w-6 h-6 mr-2 text-blue-500" fill="none"
        ...
        <div
            class="grid grid-cols-1 sm:grid-cols-4 gap-y-2 gap-x-4 text-sm text-gray-700">
    ...
    <div class="overflow-x-auto rounded-lg shadow-md border border-gray-200">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                <tr v-for="item in ficheNavette.items" :key="item.id"
                    class="hover:bg-gray-50 transition-colors">
                    <td
                        class="px-4 py-2 whitespace-nowrap text-sm text-gray-800 font-medium">
